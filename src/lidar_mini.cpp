...
int LIDARmini::getDistance() {
    std::array<char, 9> distanceRegisters = this->getWantedRegisters(0x60); // 0110 0000 because we want the 2 dist registers
...
int LIDARmini::getStrength() {
    std::array<char, 9> strengthRegisters = this->getWantedRegisters(0x18); // 0001 1000 because we want the 2 strength registers
...
int LIDARmini::getQualityDegree() {
    std::array<char, 9> qualityDegreeRegister = this->getWantedRegisters(0x02);
